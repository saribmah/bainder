...
// and three for very small (< $0.01) so a meaningful number always shows.
...
// raw "1,234,567 tokens" reads as noise; the K/M form is what users actually
// want to scan.
...
// Render the period reset as a friendly relative-ish hint: "resets May 1" or
// "resets in 12 days." Avoids depending on a heavy date library; the only
// fact users care about is when their counters zero out.
