        ...
        <Sheet className="flex flex-col gap-5 p-6 sm:p-7" showHandle={false}>
          ...
          {canChooseDocument && (
            <label className="flex flex-col gap-2">
              ...
              <select
                value={documentId}
                className="h-11 rounded-full border border-bd-border bg-bd-bg px-4 font-ui text-sm text-bd-fg outline-none focus:border-bd-focus"
          ...
          <label className="flex flex-col gap-2">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-bd-border bg-bd-bg px-4 py-3 font-reading text-[15px] leading-6 text-bd-fg outline-none placeholder:text-bd-fg-muted focus:border-bd-focus"
