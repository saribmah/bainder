...
// Refresh cadence while the window is visible. The /billing/me endpoint is
// two small D1 reads; 12s is fast enough that the sidebar meter feels live
// during an active chat session without being a chatty background poll.
