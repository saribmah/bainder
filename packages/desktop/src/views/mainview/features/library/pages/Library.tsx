      ...
      <div className="flex gap-3 overflow-x-auto pb-1">
        ...
        {shelvesLoaded && (
          <button
            type="button"
            onClick={onCreateShelf}
            className="flex min-w-[180px] shrink-0 flex-col items-center justify-center gap-2 rounded-[14px] border border-dashed border-bd-border-strong bg-bd-bg text-bd-fg-muted hover:bg-bd-surface-raised"
          >
